...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L lmb_v10_v3_0_11 -L xil_defaultlib -L lmb_bram_if_cntlr_v4_0_20 -L blk_mem_gen_v8_4_5 -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_13 -L axi_lite_ipif_v3_0_4 -L mdm_v3_2_22 -L microblaze_v11_0_8 -L generic_baseblocks_v2_1_0 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_25 -L fifo_generator_v13_2_6 -L axi_data_fifo_v2_1_24 -L axi_crossbar_v2_1_26 -L lib_pkg_v1_0_2 -L lib_srl_fifo_v1_0_2 -L axi_uartlite_v2_0_29 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot top xil_defaultlib.top xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim top -key {Behavioral:sim_tb:Functional:top} -tclbatch cmd.tcl -protoinst "protoinst_files/top.protoinst" -log simulate.log
}
...
{
  file="xsim.ini"
  lib_map_path="/eda/xilinx/Vivado/2021.2/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
