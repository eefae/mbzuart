...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../hw.gen/sources_1/bd/top/ipshared/62b6" \
       +incdir+"$ref_dir/../../../../hw.gen/sources_1/bd/top/ipshared/ec67/hdl" \
       +incdir+"../../../../hw.gen/sources_1/bd/top/ipshared/62b6" \
       +incdir+"../../../../hw.gen/sources_1/bd/top/ipshared/ec67/hdl"
}
